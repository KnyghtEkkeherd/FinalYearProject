...
class LaserScan2PointCloud : public rclcpp::Node {
    ...
    : Node("laserScan2PointCloud") {
        ...
        "sensor_msgs/LaserScan", 10, std::bind(&LaserScan2PointCloud::laser_scan_enqueue, this, _1));
    ...
    sensor_msgs::msg::LaserScan::SharedPtr laser_scan_dequeue() const {
    ...
    void conversion() const {
        ...
        sensor_msgs::msg::LaserScan::SharedPtr msg = laser_scan_dequeue();
